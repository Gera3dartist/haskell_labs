...
-- USAGE: 
-- б) з застосування функцій вищого порядку
-- :load FP_lab_work_3_variant_1
-- reverse1 _reverse1 [1,2,3]
...
-- take head, place last after head, constuct new list removing last element - and do _mix_first_last for new list
